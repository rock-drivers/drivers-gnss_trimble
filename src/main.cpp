...
int main(int argc, char** argv)
{
    ...
    mybd970.setBaudrate(iodrivers_base::Driver::SERIAL_38400);


    if (!mybd970.open(argv[1]))
    {
    ...
    {
//        sleep(1.0);
//        int number_bytes = read(mybd970.getFileDescriptor(), buffer, 235);
//        printf("Read %d bytes from %d \n", number_bytes, mybd970.getFileDescriptor());
//
//        if (number_bytes != -1)
//        {
//            for (register size_t j=0; j < (size_t) number_bytes; j++)
//            {
...
//        else
//        {
//            std::cout<<"ERROR reading from fd("<<mybd970.getFileDescriptor()<<")\n";
//        }
//    }
//
